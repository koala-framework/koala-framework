...
function smarty_compiler_component($tag_attrs, &$compiler)
{
    ...
    //$ret = "if(\$this->_tpl_vars['mode']=='fe') echo '<div id=\"container_'.".$_params['component']."['id'].'\" class=\"component '.".$_params['component']."['class'].'\">' ?".">";
    $ret = "if(isset(\$this->_tpl_vars['component']['template']) && \$this->_tpl_vars['component']['template']!='') { ?>";
