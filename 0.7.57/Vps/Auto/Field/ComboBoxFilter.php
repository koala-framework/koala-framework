<?php
class Vps_Auto_Field_ComboBoxFilter extends Vps_Auto_Field_ComboBox
{
    ...
    {
        if (! $filterObject instanceof Vps_Auto_Field_ComboBox) {
            throw new Vps_Exception('Methode setFilterComboBox der Klasse '
                .'Vps_Auto_Field_ComboBoxFilter akzeptiert nur Objekte die eine '
                .'Instanz von Vps_Auto_Field_ComboBox sind.');
        }
