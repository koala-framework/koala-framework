...
class Kwf_Assets_Dependency_FontFace extends Kwf_Assets_Dependency_Abstract
{
    ...
    {
        if (file_exists($this->_path."/fonts/$this->_name.eot")) {
            //eg icomoon, ionicons
            $fontsPath = "/assets/$this->_name/fonts/$this->_name";
        } else if (file_exists($this->_path."/fonts/".strtolower($this->_name)."-webfont.eot")) {
            //eg Font-Awesome
            $fontsPath = "/assets/$this->_name/fonts/".strtolower($this->_name)."-webfont";
        } else {
            throw new Kwf_Exception("Can't detect path of font");
        }
        $ret  = "";
        $ret .= "@font-face {\n";
        $ret .= "    font-family: 'icomoon';\n";
