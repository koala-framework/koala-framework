...
class Kwf_Db_Table
{
     ...
     * @return Kwf_Db_Table_Rowset Row(s) matching the criteria.
     * @throws Kwf_Exception
     */
    public function find()
    {
        ...
        if (count($args) < count($keyNames)) {
            throw new Kwf_Exception("Too few columns for the primary key");
        }

        if (count($args) > count($keyNames)) {
            throw new Kwf_Exception("Too many columns for the primary key");
        }
        ...
        foreach ($args as $keyPosition => $keyValues) {
            ...
            if ($numberTerms == 0) {
                ...
                throw new Kwf_Exception("Missing value(s) for the primary key");
            }
