...
class Kwf_Validate_Password3of4 extends Zend_Validate_Abstract
{
    ...
    public function __construct()
    {
        ...
        $this->_messageTemplates[self::NO_3OF4] = trlKwf("The password must contain 3 out of the following 4 character types: Small letters, capital letters, numbers and special signs");
    }
