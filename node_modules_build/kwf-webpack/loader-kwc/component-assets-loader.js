...
module.exports = function(source, map) {
    ...
    */
    ...
    var cmps = componentAssets[package];
    for (var cmp in cmps) {
        ...
        cmps[cmp].files.forEach(function(asset) {
            ...
            if (isDeferredAsset == loadDefer) {
                if (asset.match(/\.scss$/)) {
                    ret += "require('"+require.resolve('./component-file-loader')+"?cls="+cls+"!"+require.resolve('./component-inject-sass-config-loader')+"?cls="+cmp+"!./"+asset+"')\n";
                } else {
