<?php
require_once Kwf_Config::getValue('externLibraryPath.sass') . '/Extensions/ExtensionInterface.php';
class WebSass implements ExtensionInterface
{
    ...
    public static function resolveExtensionPath($callerImport, $parser, $syntax = 'scss')
    {
        ...
        if (self::$filePaths == null) {
            self::$filePaths = self::getFilesArray(getcwd().'/scss/');
        }
