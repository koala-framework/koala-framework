...
<? if ($this->doubleOptInComponentId) { ?>
    ...
    <a href="*showcomponent*<?= $this->doubleOptInComponentId; ?>*"><?= trlVps('Please click here, to confirm your E-Mail Adress and to receive our newsletters in future.'); ?></a><br /><br />
