<?php
class Vpc_Composite_ParagraphsImage_Index extends Vpc_Abstract
{
    const NAME = 'Standard.ParagraphsImage';
    protected $_settings = array(
        'paragraphsClass'      => 'Vpc_Paragraphs_Index',
    ...
    {
        $paragraphsClass = $this->_getClassFromSetting('paragraphsClass', 'Vpc_Paragraphs_Index');
