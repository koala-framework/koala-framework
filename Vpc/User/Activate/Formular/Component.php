<?php
class Vpc_User_Activate_Formular_Component extends Vpc_Formular_Component
{
    protected $_formName = 'Vpc_User_Activate_Formular_Form';

    public static function getSettings()
    {
        $ret = parent::getSettings();
        $ret['placeholder']['submitButton'] = trlVps('activate Account');
        $ret['generators']['child']['component']['success'] = 'Vpc_User_Activate_Formular_Success_Component';
        return $ret;
    }
