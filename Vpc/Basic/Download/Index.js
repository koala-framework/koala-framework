Ext.namespace('Vpc.Basic.Download');
Vpc.Basic.Download.Index = function(renderTo, config)
{
  ...
  swfu = new SWFUpload({
        ...
        flash_path : "/assets/vps/Vpc/Basic/Download/jscripts/SWFUpload/SWFUpload.swf",
