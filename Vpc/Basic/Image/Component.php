    ...
    implements Vps_Media_Output_Interface
{
    public static function getSettings()
    {
        ...
        $ret['modelname'] = 'Vpc_Basic_Image_Model';

        // Leeres Array -> freie Wahl, array(width, height), array(array(width, height), null: Bild in Originalgröße)
        $ret['dimensions'] = array(300, 200, Vps_Media_Image::SCALE_BESTFIT);

        $ret['editComment'] = false;
