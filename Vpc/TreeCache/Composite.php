    ...
    protected function _init()
    {
        if (!isset($this->_table)) {
            if (isset($this->_tableName)) {
                ...
                if (!$table) {
                    throw new Vps_Exception("Entweder tablename-setting der Komponente oder _tableName bzw. _table des TreeCaches muss geseftzt sein");
                }
