...
class Vpc_News_Directory_TreeCache extends Vpc_News_List_Abstract_TreeCache
{
    ...
    {
        $this->_additionalTreeCaches[] = 'Vpc_News_Directory_TreeCacheDetail';
        $this->_additionalTreeCaches[] = 'Vpc_News_Directory_TreeCacheMenuBox';
        $this->_additionalTreeCaches[] = 'Vpc_News_List_Abstract_TreeCacheFeed';
