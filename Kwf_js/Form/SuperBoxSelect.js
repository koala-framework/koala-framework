 ...
 *
 */
Kwf.Form.SuperBoxSelect = function(config) {
    Kwf.Form.SuperBoxSelect.superclass.constructor.call(this,config);
    this.addEvents(
        /**
         ...
         * @event beforeadditem
         * @memberOf Kwf.Form.SuperBoxSelect
...
Kwf.Form.SuperBoxSelect = Ext.extend(Kwf.Form.SuperBoxSelect, Kwf.Form.ComboBox,{
    ...
    initComponent:function() {
       Ext.apply(this, {
        ...
        Kwf.Form.SuperBoxSelect.superclass.initComponent.call(this);
    ...
    onRender:function(ct, position) {
        ...
        Kwf.Form.SuperBoxSelect.superclass.onRender.call(this, ct, position);
        this.hiddenName = h;
    ...
    onFocus: function() {
        ...
        Kwf.Form.SuperBoxSelect.superclass.onFocus.call(this);
    },
    ...
    onBlur: function() {
        ...
        Kwf.Form.SuperBoxSelect.superclass.onBlur.call(this);
    },
    ...
    onResize : function(w, h, rw, rh) {
        ...
        Kwf.Form.SuperBoxSelect.superclass.onResize.call(this, w, h, rw, rh);
        this.autoSize();
    },
    onEnable: function(){
        Kwf.Form.SuperBoxSelect.superclass.onEnable.call(this);
    ...
    onDisable: function(){
        Kwf.Form.SuperBoxSelect.superclass.onDisable.call(this);
        this.items.each(function(item){
            item.disable();
        });
        if(this.renderFieldBtns){
     ...
     * @methodOf Kwf.Form.SuperBoxSelect
     * @name clearValue
    ...
    clearValue : function(supressRemoveEvent){
        Kwf.Form.SuperBoxSelect.superclass.clearValue.call(this);
    ...
    reset :  function(){
        this.killItems();
        Kwf.Form.SuperBoxSelect.superclass.reset.call(this);
        this.addedRecords = [];
    ...
    /**
     * Adds an array of items to the SuperBoxSelect component if the {@link #Kwf.Form.SuperBoxSelect-allowAddNewData} config is set to true.
     * @methodOf Kwf.Form.SuperBoxSelect
     * @name addItem
    ...
    /**
     * Adds a new non-existing item to the SuperBoxSelect component if the {@link #Kwf.Form.SuperBoxSelect-allowAddNewData} config is set to true.
     * This method should be used in place of addItem from within the newitem event handler.
     * @methodOf Kwf.Form.SuperBoxSelect
     * @name addNewItem
     * @param {Object} newItemObject An object literal containing the property names and values for an item. The property names must match those specified in {@link #Kwf.Form.SuperBoxSelect-displayField}, {@link #Kwf.Form.SuperBoxSelect-valueField} and {@link #Kwf.Form.SuperBoxSelect-classField}
     */
    addNewItem : function(newItemObject){
        this.addItem(newItemObject,true);
    },
    /**
     * Adds an item to the SuperBoxSelect component if the {@link #Kwf.Form.SuperBoxSelect-allowAddNewData} config is set to true.
     * @methodOf Kwf.Form.SuperBoxSelect
     * @name addItem
     * @param {Object} newItemObject An object literal containing the property names and values for an item. The property names must match those specified in {@link #Kwf.Form.SuperBoxSelect-displayField}, {@link #Kwf.Form.SuperBoxSelect-valueField} and {@link #Kwf.Form.SuperBoxSelect-classField}
     */
    ...
    /**
     * Returns a String value containing a concatenated list of item values. The list is concatenated with the {@link #Kwf.Form.SuperBoxSelect-valueDelimiter}.
     * @methodOf Kwf.Form.SuperBoxSelect
     * @name getValue
    ...
    /**
     * Returns an Array of item objects containing the {@link #Kwf.Form.SuperBoxSelect-displayField}, {@link #Kwf.Form.SuperBoxSelect-valueField}, {@link #Kwf.Form.SuperBoxSelect-classField} and {@link #Kwf.Form.SuperBoxSelect-styleField} properties.
     * @methodOf Kwf.Form.SuperBoxSelect
     * @name getValueEx
    ...
    initValue : function(){
        if(Ext.isObject(this.value) || Ext.isArray(this.value)){
            ...
            Kwf.Form.SuperBoxSelect.superclass.initValue.call(this);
        }
        if(this.mode === 'remote') {
     ...
     * @methodOf Kwf.Form.SuperBoxSelect
     * @name setValue
     * @param {String|Array} value An array of item values, or a String value containing a delimited list of item values. (The list should be delimited with the {@link #Kwf.Form.SuperBoxSelect-valueDelimiter)
     */
    ...
    /**
     * Sets the value of the SuperBoxSelect component, adding new items that don't exist in the data store if the {@link #Kwf.Form.SuperBoxSelect-allowAddNewData} config is set to true.
     * @methodOf Kwf.Form.SuperBoxSelect
     * @name setValue
     * @param {Array} data An Array of item objects containing the {@link #Kwf.Form.SuperBoxSelect-displayField}, {@link #Kwf.Form.SuperBoxSelect-valueField} and {@link #Kwf.Form.SuperBoxSelect-classField} properties.
     */
    ...
    onDestroy : function() {
        ...
        Kwf.Form.SuperBoxSelect.superclass.onDestroy.call(this);
    },
    autoSize : function(){
        if(!this.rendered){
            return this;
...
Kwf.Form.SuperBoxSelectItem = Ext.extend(Kwf.Form.SuperBoxSelectItem,Ext.Component, {
    ...
    onRender : function(ct, position){
        ...
        Kwf.Form.SuperBoxSelectItem.superclass.onRender.call(this, ct, position);
    ...
    onDisable : function() {
        ...
        this.keyMap.disable();
        Kwf.Form.SuperBoxSelectItem.superclass.onDisable.call(this);
    },
    onEnable : function() {
        if(this.hidden){
    ...
    onDestroy : function() {
        ...
        Kwf.Form.SuperBoxSelectItem.superclass.onDestroy.call(this);
    }
});
