 ...
 *
 * Internal class that manages drag/drop for {@link Kwf.Ext4.Portal.Panel}.
 */
Ext4.define('Kwf.Ext4.Portal.DropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext4.dd.ScrollManager.register(portal.body);
        Kwf.Ext4.Portal.DropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        Kwf.Ext4.Portal.DropZone.superclass.unreg.call(this);
    }
});
