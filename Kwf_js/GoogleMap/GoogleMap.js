...
Kwf.GoogleMap.load = function(callback, scope)
{
    ...
    var url = location.protocol+'/'+'/'+'/maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&key={Kwf_Assets_GoogleMapsApiKey::getKey()}&c&libraries=places&async=2&language='+trlKwf('en');
