E3.Component.Paragraphs = function(componentId, componentClass) {
    E3.Component.Paragraphs.superclass.constructor.call(this, componentId, componentClass);
    
};
YAHOO.lang.extend(E3.Component.Paragraphs, E3.Component.Abstract);

E3.Component.Paragraphs.prototype.handleSave = function() {
    var data = 'order=';
...
E3.Component.Paragraphs.prototype.init = function() {
	...
	for(var i = 0; i < this.htmlelement.childNodes.length; i++) {
	    ...
	    if(node.nodeName.toLowerCase() == "div" && 
    		...
    		var dd = new E3ParagraphDragDrop(container);
	    }
	}
}

function E3ParagraphDragDrop(container, sGroup, config) {
    if (container) {
...
E3ParagraphDragDrop.prototype = new YAHOO.util.DDProxy();

E3ParagraphDragDrop.prototype.startDrag = function(x, y) {
...
E3ParagraphDragDrop.prototype.endDrag = function(e) {
    var el = this.getEl();
...
E3ParagraphDragDrop.prototype.onDrag = function(e, id) {
...
E3ParagraphDragDrop.prototype.onDragOver = function(e, id)
{
    var srcEl = this.getEl();
    var destEl;
