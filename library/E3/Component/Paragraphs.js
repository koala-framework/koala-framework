YAHOO.E3.Component.Paragraphs = function(componentId, componentClass) {
    YAHOO.E3.Component.Paragraphs.superclass.constructor.call(this, componentId, componentClass);
    
};
YAHOO.lang.extend(YAHOO.E3.Component.Paragraphs, YAHOO.E3.Component.Abstract);

YAHOO.E3.Component.Paragraphs.prototype.handleSave = function() {
    var data = 'order=';
...
YAHOO.E3.Component.Paragraphs.prototype.init = function() {
	...
	for(var i = 0; i < this.htmlelement.childNodes.length; i++) {
	    ...
	    if(node.nodeName.toLowerCase() == "div" && 
            ...
            container.moveButton.className = 'E3ParagraphsMoveButton';
    		...
    		var dd = new YAHOO.E3.ParagraphDragDrop(container);
	    }
	}
}
YAHOO.namespace('YAHOO.E3.ParagraphDragDrop');

YAHOO.E3.ParagraphDragDrop = function (container, sGroup, config) {
    if (container) {
...
YAHOO.E3.ParagraphDragDrop.prototype = new YAHOO.util.DDProxy();

YAHOO.E3.ParagraphDragDrop.prototype.startDrag = function(x, y) {
...
YAHOO.E3.ParagraphDragDrop.prototype.endDrag = function(e) {
    var el = this.getEl();
...
YAHOO.E3.ParagraphDragDrop.prototype.onDrag = function(e, id) {
...
YAHOO.E3.ParagraphDragDrop.prototype.onDragOver = function(e, id)
{
    var srcEl = this.getEl();
    var destEl;
