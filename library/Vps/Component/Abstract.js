YAHOO.namespace('YAHOO.Vps.Component');
var Vps = YAHOO.Vps;

YAHOO.Vps.createComponent = function(componentId, componentClass)
{
...
YAHOO.Vps.createComponentCallback = function(data) {
    eval('new '+data.componentClass.replace(/_/g, '.')+'(\''+data.componentId+'\', \''+data.componentClass+'\');');
}


YAHOO.Vps.Component.Abstract = function(componentId, componentClass) {
...
YAHOO.Vps.Component.Abstract.prototype.init = function() {
  ...
  this.editButton.set('className', 'VpsAbstractEditButton');
...
YAHOO.Vps.Component.Abstract.prototype.handleSuccess = function(o) {
...
YAHOO.Vps.Component.Abstract.prototype.handleEditSuccess = function(o)
{
...
YAHOO.Vps.Component.Abstract.prototype.handleMouseOver = function(o, scope) { 
    scope.editButton.setStyle('display', 'block');
};

YAHOO.Vps.Component.Abstract.prototype.handleMouseOut = function(o, scope) { 
    scope.editButton.setStyle('display', 'none');
};

YAHOO.Vps.Component.Abstract.prototype.handleSave = function() {
...
YAHOO.Vps.Component.Abstract.prototype.handleCancel = function() {
    this.htmlelement.isInEditMode = false;
...
YAHOO.Vps.Component.Abstract.prototype.handleClick = function(o, e) {
