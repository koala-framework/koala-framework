...
class Vps_Controller_Action_Pages extends Vps_Controller_Action
{
    public function actionAction()
    {
        ...
        while ($page instanceof Vps_Component_Interface && $page->getId() != $pageCollection->getRootPage()->getId()) {
            $tree[] = $page->getId();
        ...
        $view = new Vps_View_Smarty('../library/Vps/Controller/Action', $options);
