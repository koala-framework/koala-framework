Vps.Auto.AssignGridPanel = Ext.extend(Vps.Auto.AbstractPanel,
    ...
    initComponent: function
        ...
        this.gridAssigned = new Vps.Auto.AssignedGridPanel
            controllerUrl: this.gridAssignedControllerUr
            textAssignActionUrl: this.textAssignActionUr
            region: 'cente
        }
        ...
        this.gridData = new Vps.Auto.GridPanel
            region: 'south
            split: tru
            height: this.gridDataHeigh
            controllerUrl: this.gridDataControllerUr
            gridConfig:
    ...
    onAssign : function
        ...
        if (!this.gridData.getSelectionModel().getSelections()) retur
