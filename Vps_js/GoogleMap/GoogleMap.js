...
Vps.GoogleMap.load = function(callback, scope)
{
    ...
    var url = 'http:/'+'/maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&key={Vps_Assets_GoogleMapsApiKey::getKey()}&c&libraries=places&async=2&language='+trlVps('en');
...
Ext.extend(Vps.GoogleMap.Map, Ext.util.Observable, {
    ...
    showWindow : function(marker) {
        ...
        if (marker.vpsConfig.infoHtml && marker.vpsConfig.infoHtml != ""
            ...
            marker.infoWindow.setContent(marker.vpsConfig.infoHtml);
