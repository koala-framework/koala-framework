...
Vps.Menu.Index = Ext.extend(Ext.Toolbar, 
    ...
    loadMenu: function(r
        ...
        menuItems.each(function(menuItem) 
            ...
            //button (in oberster ebene) kann kein href, darum mit handler fake
            if (menuItem.href) 
        ...
        if (response.authData && response.authData.realname) 
            this.add(
                ...
                handler: function() 
                    //todo: display user settings dialo
                }
                scope: thi
            })
                ...
                handler: function() 
                    Ext.Ajax.request(
                        ...
                        success : function(form, action) 
                            //nicht reload, weil user nach erneutem login vielleich
                            //die aktuelle seite gar nicht mehr sehen dar
                            location.href = '/';
                        }
                        scope: thi
                    })
