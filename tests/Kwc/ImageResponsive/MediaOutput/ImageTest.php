...
class Kwc_ImageResponsive_MediaOutput_ImageTest extends Kwc_TestAbstract
{
    ...
    {
        $file200 = Kwf_Media::getOutput('Kwc_ImageResponsive_MediaOutput_Image_TestComponent', 'root_imageabstract1', 'dh-200');
        $image = new Imagick();
    ...
    {
        $file100 = Kwf_Media::getOutput('Kwc_ImageResponsive_MediaOutput_Image_TestComponent', 'root_imageabstract1', 'dh-100');
        $image = new Imagick();
    ...
    public function testImageCacheDeletedAfterDimensionsChange()
    {
        ...
        // Dpr2 size
        $otherfile200 = Kwf_Media::getOutput('Kwc_ImageResponsive_MediaOutput_Image_TestComponent', 'root_imageabstract1', 'dh-200');
        // Normal size
        $otherfile100 = Kwf_Media::getOutput('Kwc_ImageResponsive_MediaOutput_Image_TestComponent', 'root_imageabstract1', 'dh-100');
