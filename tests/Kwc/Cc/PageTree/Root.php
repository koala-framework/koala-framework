<?php
class Kwc_Cc_PageTree_Root extends Kwc_Root_Abstract
{
    public static function getSettings()
    {
        ...
        $ret['generators']['master'] = array(
            ...
            'component' => 'Kwc_Cc_PageTree_Master_Component',
        );
        $ret['generators']['slave'] = array(
            'class' => 'Kwc_Chained_Trl_ChainedGenerator',
            'component' => 'Kwc_Cc_PageTree_Slave_Component.Kwc_Cc_PageTree_Master_Component',
