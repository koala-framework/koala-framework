...
*/
    ...
    public function testMenuCc()
    {
        ...
        $this->assertContains('<a href="/slave/2">Seite 2</a>', $html);
        $this->assertContains('<a href="/slave/3">Seite 3</a>', $html);
    ...
    public function testBottomMenuCc()
    {
        ...
        $html = $c->render(true, false);
        $this->assertContains('<a href="/slave/5">Seite 5</a>', $html);
    ...
    public function testMenuCcClearCacheNameAndFilenameChanged()
    {
        ...
        $c = Kwf_Component_Data_Root::getInstance()->getComponentById('root-slave-main-mainMenu');
        $html = $c->render(true, false);
        $this->assertContains('<a href="/slave/seite_2_xy">Seite 2 xy</a>', $html);
        $this->assertContains('<a href="/slave/3">Seite 3</a>', $html);
    ...
    public function testMenuCcClearCacheParentChanged()
    {
        ...
        $this->assertContains('<a href="/slave/seite_4">Seite 4</a>', $html);
    ...
    public function testMenuCcClearCachePositionChanged()
    {
        ...
        $c = Kwf_Component_Data_Root::getInstance()->getComponentById('root-slave-main-mainMenu');
        $html = $c->render(true, false);
        $this->assertRegExp('#<a href="/slave/3">Seite 3</a>.*<a href="/slave/seite_2">Seite 2</a>#s', $html);
