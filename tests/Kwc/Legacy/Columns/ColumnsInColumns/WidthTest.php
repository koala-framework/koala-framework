 ...
 * @group Kwc_Columns
 */
class Kwc_Legacy_Columns_ColumnsInColumns_WidthTest extends Kwc_TestAbstract
{
    public function setUp()
    {
        parent::setUp('Kwc_Legacy_Columns_ColumnsInColumns_Root');
    }
    ...
    public function testChangeWidth1()
    {
        ...
        $row = Kwf_Model_Abstract::getInstance('Kwc_Legacy_Columns_ColumnsInColumns_Columns_ColumnsTestModel')
            ->getRow(1);
        $row->width = 190;
        $row->save();
    ...
    public function testBoxChangesContent()
    {
        ...
        $row = Kwf_Model_Abstract::getInstance('Kwc_Legacy_Columns_ColumnsInColumns_Box_TestModel')
            ->getRow('3-box');
        $row->content = '';
        $row->save();
