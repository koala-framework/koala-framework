<?php
class Kwc_Legacy_Columns_ColumnsInColumns_Root extends Kwf_Component_NoCategoriesRoot
{
    public static function getSettings()
    {
        ...
        $ret['generators']['page']['component'] = array(
            'columns' => 'Kwc_Legacy_Columns_ColumnsInColumns_Paragraphs_Component',
        );

        $ret['generators']['box'] = array(
            'class' => 'Kwf_Component_Generator_Box_Static',
            'component' => 'Kwc_Legacy_Columns_ColumnsInColumns_Box_Component',
            'inherit' => true,
        );
