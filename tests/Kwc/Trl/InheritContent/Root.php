<?php
class Kwc_Trl_InheritContent_Root extends Kwc_Root_Abstract
{
    public static function getSettings()
    {
        ...
        $ret['generators']['de'] = array(
            ...
            'component' => 'Kwc_Trl_InheritContent_German',
            'name' => 'de'
        );
        $ret['generators']['en'] = array(
            'class' => 'Kwc_Chained_Trl_ChainedGenerator',
            'component' => 'Kwc_Trl_InheritContent_English.Kwc_Trl_InheritContent_German',
            'name' => 'en'
        );
        return $ret;
    }
