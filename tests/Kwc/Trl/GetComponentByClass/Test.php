...
class Kwc_Trl_GetComponentByClass_Test extends Kwc_TestAbstract
{
    ...
    {
        $c = Kwf_Component_Data_Root::getInstance()->getComponentsByClass('Kwc_Basic_Empty_Component');
    ...
    {
        $c = Kwf_Component_Data_Root::getInstance()->getComponentsByClass('Kwc_Chained_Trl_Component.Kwc_Basic_Empty_Component');
        $this->assertEquals(1, count($c));
    ...
    {
        $c = 'Kwc_Chained_Trl_Component.Kwc_Basic_Empty_Component';
