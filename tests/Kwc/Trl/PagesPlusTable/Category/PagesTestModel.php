<?php
class Kwc_Trl_PagesPlusTable_Category_PagesTestModel extends Kwf_Model_FnF
{
    protected $_data = array(
            array('id'=>1, 'pos'=>1, 'visible'=>true, 'name'=>'Home de', 'filename' => 'home_de', 'custom_filename' => false,
                  'parent_id'=>'root-master-main', 'component'=>'testTable', 'is_home'=>true, 'hide'=>false, 'parent_subroot_id'=>'root-master'),
