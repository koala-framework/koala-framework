<?php
class Kwc_FavouritesSelenium_Root_PagesModel extends Kwf_Model_Session
{
    protected $_data = array(
        ...
        array('id'=>2006, 'pos'=>7, 'visible'=>true, 'name'=>'selenium', 'filename' => 'selenium', 'custom_filename' => false,
              'parent_id'=>'root', 'component'=>'selenium', 'is_home'=>false, 'category' =>'main', 'hide'=>false, 'parent_subroot_id' => 'root'),
    );
}
