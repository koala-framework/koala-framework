...
class Kwc_Basic_ImageEnlarge_PageTestModel extends Kwf_Model_FnF
{
    protected $_data = array(
            ...
            array('id'=>1801, 'pos'=>2, 'visible'=>true, 'name'=>'Foo', 'filename' => 'foo2',
                  'parent_id'=>'root', 'component'=>'image', 'is_home'=>false, 'category' =>'main', 'hide'=>false),
            array('id'=>1802, 'pos'=>3, 'visible'=>true, 'name'=>'Foo', 'filename' => 'foo3',
                  'parent_id'=>'root', 'component'=>'image', 'is_home'=>false, 'category' =>'main', 'hide'=>false),
            array('id'=>1803, 'pos'=>4, 'visible'=>true, 'name'=>'Foo', 'filename' => 'foo4',
                  'parent_id'=>'root', 'component'=>'imageWithOriginal', 'is_home'=>false, 'category' =>'main', 'hide'=>false),
            array('id'=>1804, 'pos'=>5, 'visible'=>true, 'name'=>'Foo', 'filename' => 'foo5',
                  'parent_id'=>'root', 'component'=>'imageWithoutSmall', 'is_home'=>false, 'category' =>'main', 'hide'=>false),
        );
}
