<?php
class Vps_Cc_Master_Master_Component extends Vpc_Root_TrlRoot_Master_Component
{
    public static function getSettings()
    {
        ...
        $ret['generators']['category']['component'] = 'Vps_Cc_Master_Master_Category_Component';
