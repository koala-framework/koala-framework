...
class Vps_Component_CacheVars_Menu_Test extends PHPUnit_Framework_TestCase
{
    ...
    public function testMenu()
    {
        ...
        $this->assertEquals(5, count($cacheVars));
        ...
        $this->assertEquals('Vps_Dao_Pages', $cacheVars[3]['model']);
        $this->assertEquals(null, $cacheVars[3]['id']);
        $this->assertEquals(Vps_Registry::get('config')->user->model, $cacheVars[4]['model']);
        $this->assertEquals(null, $cacheVars[4]['id']);
    }
}
