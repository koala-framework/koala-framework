<?php
class Vps_Component_Generator_InheritComponentClass_Test extends PHPUnit_Framework_TestCase
{
    private $_root;
    public function setUp()
    {
        Vps_Component_Data_Root::setComponentClass('Vps_Component_Generator_InheritComponentClass_Root');
