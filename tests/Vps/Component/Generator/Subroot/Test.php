 ...
 */
class Vps_Component_Generator_Subroot_Test extends PHPUnit_Framework_TestCase
{
    private $_root;
    public function setUp()
    {
        Vps_Component_Data_Root::setComponentClass('Vps_Component_Generator_Subroot_Root');
