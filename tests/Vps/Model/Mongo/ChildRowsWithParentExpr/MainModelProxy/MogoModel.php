<?php
class Vps_Model_Mongo_ChildRowsWithParentExpr_MainModelProxy_MogoModel extends Vps_Model_Proxy
{
    protected function _init()
    {
        ...
        $this->_dependentModels['Foo'] = new Vps_Model_Mongo_RowsSubModel(array(
            ...
            'referenceMap' => array(
                'Parent' => array(
                    'refModelClass' => 'Vps_Model_Mongo_ChildRowsWithParentExpr_MainModelProxy_ParentModel',
                    'column' => 'parent_id'
                ),
