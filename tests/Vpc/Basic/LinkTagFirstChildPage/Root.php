<?php
class Vpc_Basic_LinkTagFirstChildPage_Root extends Vpc_Root_Component
{
    public static function getSettings()
    {
        ...
        $ret['generators']['page']['model'] = new Vps_Model_FnF(array('data'=>array(
            ...
            array('id'=>1501, 'pos'=>1, 'visible'=>true, 'name'=>'Foo', 'filename' => 'bar1',
                  'parent_id'=>1500, 'component'=>'empty', 'is_home'=>false, 'type'=>'main', 'hide'=>false),
            ...
            array('id'=>1503, 'pos'=>1, 'visible'=>true, 'name'=>'Foo', 'filename' => 'bar2',
                  'parent_id'=>1502, 'component'=>'link', 'is_home'=>false, 'type'=>'main', 'hide'=>false),
            array('id'=>1504, 'pos'=>1, 'visible'=>true, 'name'=>'Foo', 'filename' => 'baz2',
                  'parent_id'=>1503, 'component'=>'empty', 'is_home'=>false, 'type'=>'main', 'hide'=>false),
