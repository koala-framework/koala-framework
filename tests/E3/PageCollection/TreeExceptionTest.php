...
class E3_PageCollection_TreeExceptionTest extends E3_ExceptionTes
    ...
    public function testAddPage1(
		...
		$component = new E3_Component_Textbox($this->_dao, -1)
    ...
    public function testAddPage2(
		...
		$c1 = new E3_Component_Textbox($this->_dao, -1)
		$this->_pc->addPage($c1, '')
    ...
    public function testSetWrongParentPage2(
		...
		$component1 = new E3_Component_Textbox($this->_dao, -1)
		$component2 = new E3_Component_Textbox($this->_dao, -2)
