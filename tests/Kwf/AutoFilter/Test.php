 ...
 * @group AutoFilter
 */
class Kwf_AutoFilter_Test extends Kwf_Test_TestCase
{
    public function testTextFilter()
    {
        ...
        $filter = new Kwf_Controller_Action_Auto_Filter_Text();
    ...
    public function testDateRangeFilter()
    {
        ...
        $filter = new Kwf_Controller_Action_Auto_Filter_DateRange();
        $filter->setModel($model);
