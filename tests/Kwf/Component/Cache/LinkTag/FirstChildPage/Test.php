...
class Kwf_Component_Cache_LinkTag_FirstChildPage_Test extends Kwc_TestAbstract
{
    ...
    public function testParentFilenameChange()
    {
        ...
        $this->assertEquals(
            '<a href="/kwf/kwctest/Kwf_Component_Cache_LinkTag_FirstChildPage_Root_Component/f1/f2/f3" rel=""><span>f2</span></a>',
        ...
        $this->assertEquals(
            '<a href="/kwf/kwctest/Kwf_Component_Cache_LinkTag_FirstChildPage_Root_Component/g1/f2/f3" rel=""><span>f2</span></a>',
            $this->_root->render(true, false)
        );
    }
    ...
    public function testChildFilenameChange()
    {
        ...
        $this->assertEquals(
            '<a href="/kwf/kwctest/Kwf_Component_Cache_LinkTag_FirstChildPage_Root_Component/f1/f2/g3" rel=""><span>f2</span></a>',
            $this->_root->render(true, false)
        );
    }
    ...
    public function testChildPositionChange()
    {
        ...
        $this->assertEquals(
            '<a href="/kwf/kwctest/Kwf_Component_Cache_LinkTag_FirstChildPage_Root_Component/f1/f2/f4" rel=""><span>f2</span></a>',
            $this->_root->render(true, false)
        );
    }
    ...
    public function testPageDeleteAdd()
    {
        ...
        $this->_process();
        $this->assertEquals(
            '<a href="/kwf/kwctest/Kwf_Component_Cache_LinkTag_FirstChildPage_Root_Component/f1/f2/f6" rel=""><span>f2</span></a>',
            $this->_root->render(true, false)
        );
