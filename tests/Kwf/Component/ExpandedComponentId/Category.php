    ...
    public static function getSettings()
    {
        ...
        $ret['generators']['page']['model'] = new Kwf_Model_FnF(array('data'=>array(
            array('id'=>1, 'pos'=>1, 'visible'=>true, 'name'=>'Home', 'filename' => 'home', 'parent_subroot_id'=>'root', 'custom_filename'=>false,
                  'parent_id'=>'root-main', 'component'=>'empty', 'is_home'=>true, 'category' =>'main', 'hide'=>false, 'parent_subroot_id' => 'root-main'),
            array('id'=>2, 'pos'=>1, 'visible'=>true, 'name'=>'Foo', 'filename' => 'foo', 'parent_subroot_id'=>'root', 'custom_filename'=>false,
                  'parent_id'=>1, 'component'=>'child', 'is_home'=>false, 'category' =>'main', 'hide'=>false, 'parent_subroot_id' => 'root-main'),
        )));
