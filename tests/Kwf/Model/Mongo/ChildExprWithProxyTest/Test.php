 ...
 * @group slow
 */
class Kwf_Model_Mongo_ChildExprWithProxyTest_Test extends Kwf_Test_TestCase
{
...
/*
    ...
    public function setUp()
    {
        ...
        $this->_model = Kwf_Model_Abstract::getInstance('Kwf_Model_Mongo_ChildExprWithProxyTest_MongoModel');
    ...
    public function testAddedChild()
    {
        ...
        $childModel = Kwf_Model_Abstract::getInstance('Kwf_Model_Mongo_ChildExprWithProxyTest_ChildModel');
