<?php
class Kwf_Model_Mongo_ChildRowsWithParentExpr_BothProxy_MongoModel extends Kwf_Model_Proxy
{
    protected function _init()
    {
        ...
        $this->_dependentModels['Foo'] = new Kwf_Model_Mongo_RowsSubModel(array(
            ...
            'referenceMap' => array(
                'Parent' => array(
                    'refModelClass' => 'Kwf_Model_Mongo_ChildRowsWithParentExpr_BothProxy_ParentModel',
                    'column' => 'parent_id'
                ),
