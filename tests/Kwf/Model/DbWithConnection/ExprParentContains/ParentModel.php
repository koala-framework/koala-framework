<?php
class Kwf_Model_DbWithConnection_ExprParentContains_ParentModel extends Kwf_Model_Db
{
    private $_tableName;
    public function __construct($config = array())
    {
        ...
        $this->_dependentModels['Childs'] = 'Kwf_Model_DbWithConnection_ExprParentContains_Model';
