<?php
class Kwf_Model_DbWithConnection_ProxyReferences_ParentModel extends Kwf_Model_Db
{
    private $_tableName;
    public function __construct($config = array())
    {
        ...
        $this->_dependentModels['StartChilds'] = 'Kwf_Model_DbWithConnection_ProxyReferences_StartChildModel';
