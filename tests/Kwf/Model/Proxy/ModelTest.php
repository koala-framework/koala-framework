 ...
 * @group Model_Proxy
 */
class Kwf_Model_Proxy_ModelTest extends Kwf_Test_TestCase
{
    public function testIsEqual()
    {
        ...
        $proxy = new Kwf_Model_Proxy(array('proxyModel' => $fnf1));

        $proxySame = new Kwf_Model_Proxy(array('proxyModel' => $fnf1));
        $proxyNotSame = new Kwf_Model_Proxy(array('proxyModel' => $fnf2));
    ...
    public function testPrimary()
    {
        ...
        $fnf1 = new Kwf_Model_FnF(array('primaryKey' => 'user_id'));
        $proxy = new Kwf_Model_Proxy(array('proxyModel' => $fnf1));
    ...
    public function testCreateRow()
    {
        ...
        $this->assertEquals('Kwf_Model_Proxy_Row', get_class($row));
    ...
    public function testColumns()
    {
        ...
        $fnf1 = new Kwf_Model_FnF(array('columns' => array('id', 'user_id')));
        $proxy = new Kwf_Model_Proxy(array('proxyModel' => $fnf1));
