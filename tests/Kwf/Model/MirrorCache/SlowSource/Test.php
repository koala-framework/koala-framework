 ...
 * @group slow
 */
class Kwf_Model_MirrorCache_SlowSource_Test extends Kwf_Test_TestCase
{
    public function testRequests()
    {
        $m = Kwf_Model_Abstract::getInstance('Kwf_Model_MirrorCache_SlowSource_TestModel');
        ...
        $cmd = "php ".KWF_PATH."/bootstrap.php test forward --controller=kwf_model_mirror-cache_slow-source_test";
