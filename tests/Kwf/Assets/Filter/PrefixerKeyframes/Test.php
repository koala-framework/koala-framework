...
class Kwf_Assets_Filter_PrefixerKeyframes_Test extends Kwf_Test_TestCase
{
    ...
    {
        $d = new Kwf_Assets_Dependency_File_Scss(new Kwf_Assets_Dependency_EmptyProviderList(), 'kwf/tests/Kwf/Assets/Filter/PrefixerKeyframes/test1.scss');
    ...
    {
        $d = new Kwf_Assets_Dependency_File_Scss(new Kwf_Assets_Dependency_EmptyProviderList(), 'kwf/tests/Kwf/Assets/Filter/PrefixerKeyframes/test2.scss');
        $map = $d->getContentsPacked();
    ...
    {
        $d = new Kwf_Assets_Dependency_File_Scss(new Kwf_Assets_Dependency_EmptyProviderList(), 'kwf/tests/Kwf/Assets/Filter/PrefixerKeyframes/test3.scss');
        $map = $d->getContentsPacked();
