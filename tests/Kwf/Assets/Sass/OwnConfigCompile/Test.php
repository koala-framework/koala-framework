 ...
 * @group Sass
 */
class Kwf_Assets_Sass_OwnConfigCompile_Test extends Kwf_Test_TestCase
{
    public function testIt()
    {
        ...
        $type = 'Kwf_Assets_Sass_OwnConfigCompile:Test';
        $files = $dep->getAssetUrls($type, 'css', 'web', false);
        $expected = array(
            '/assets/all/web/'.Kwf_Trl::getInstance()->getTargetLanguage().'/Kwf_Assets_Sass_OwnConfigCompile:Test.css?v='.$v,
        );
