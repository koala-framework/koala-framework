...
class Kwf_Assets_Sass_WithComponentScss_Test extends Kwf_Test_TestCase
{
    public function testIt()
    {
        ...
        $rootComponent = 'Kwf_Assets_Sass_WithComponentScss_Root_Component';
        ...
        $type = 'Kwf_Assets_Sass_WithComponentScss:Test';
        $files = $dep->getAssetUrls($type, 'css', 'web', $rootComponent);
        $expected = array(
            "/assets/all/web/$rootComponent/".Kwf_Trl::getInstance()->getTargetLanguage()."/Kwf_Assets_Sass_WithComponentScss:Test.css?v=".$v,
        );
