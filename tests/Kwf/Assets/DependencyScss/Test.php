...
class Kwf_Assets_DependencyScss_Test extends Kwf_Test_TestCase
{
    ...
    {
        $f = new Kwf_Assets_Dependency_File_Scss(new Kwf_Assets_Dependency_EmptyProviderList(), 'kwf/tests/Kwf/Assets/DependencyScss/file1.scss');
    ...
    {
        $f = new Kwf_Assets_Dependency_File_Scss(new Kwf_Assets_Dependency_EmptyProviderList(), 'kwf/tests/Kwf/Assets/DependencyScss/file2.scss');
        $c = $f->getContentsPacked()->getFileContents();
    ...
    {
        $f = new Kwf_Assets_Dependency_File_Scss(new Kwf_Assets_Dependency_EmptyProviderList(), 'kwf/tests/Kwf/Assets/DependencyScss/globalsetting.scss');
        $c = $f->getContents('en');
