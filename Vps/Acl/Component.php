<?p
class Vps_Acl_Component extends Vps_A
    ...
    public function __construct
        ...
        $this->add(new Vps_Acl_Resource_MenuUrl('pages
            ...
            $this->add(new Zend_Acl_Resource('components'), 'pages'); // für /component/sh
            $this->add(new Zend_Acl_Resource('component'), 'pages'); // für /component/ed
