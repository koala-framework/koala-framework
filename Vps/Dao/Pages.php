<?ph
class Vps_Dao_Pages extends Vps_Db_Tabl
    ...
    private function _retrievePageData(
        ...
        if ($this->_pageData == null) 
            ...
            $sql = 
                SELECT id, parent_id, type, is_home, visible, hide, name, filename, component_clas
                FROM vps_page
                ' . $where . 
                ORDER BY po
            '
