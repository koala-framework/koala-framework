<?php
class Vps_Form_Field_TextField_Controller extends Vps_Controller_Action_Auto_Vpc_Form
{
    ...
    protected function _initFields()
    {
        ...
        $this->_form->add(new Vps_Form_Field_TextField('value', trlVps('Default Value')))
            ->setWidth(150);
        $this->_form->add(new Vps_Form_Field_ComboBox('validator', trlVps('Validator')))
