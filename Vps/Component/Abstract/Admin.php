...
class Vps_Component_Abstract_Admin
{
    ...
    public function componentToString(Vps_Component_Data $data)
    {
        ...
        try {
            ...
            throw new Vps_Exception("__toString failed for row ".get_class($data->getComponent()->getRow()->getModel()).' you might want to set _toStringField or override componentToString');
        }
    }
