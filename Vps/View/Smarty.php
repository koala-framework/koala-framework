...
class Vps_View_Smarty extends Zend_View_Abstrac
    ...
    protected function _run(
        ...
        //why 'this'
        //to emulate standard zend view functionalit
        //doesn't mess up smarty in any wa
        $this->_smarty->assign_by_ref('this', $this)

        //smarty needs a template_dir, and can only use templates
        //found in that directory, so we have to strip it from the filenam
