...
CREATE TABLE IF NOT EXISTS `cache_component` (
  ...
  `db_id` varchar(255) collate utf8_general_ci default NULL,
  `component_class` varchar(255) collate utf8_general_ci NOT NULL,
  `type` enum('component','master','partials','partial','mail') collate utf8_general_ci NOT NULL,
  `value` varchar(255) collate utf8_general_ci NOT NULL default '' COMMENT 'Bei Partial partialId oder bei master component_id zu der das master gehört',
