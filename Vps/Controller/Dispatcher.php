<?ph
class Vps_Controller_Dispatcher extends Zend_Controller_Dispatcher_Standar
    ...
    public function getControllerClass(Zend_Controller_Request_Abstract $request
        ...
        if ($module == 'component' && $request->getControllerName() == 'component') 
            ...
            // Zuerst direkt Controller zu Klasse suche
            if (class_exists($class . 'Controller')) 
                $className = $class . 'Controller'
            
           
            // Wenn nicht gefunden, Vererbungshierarchie durchlaufe
            if ($className == '') 
